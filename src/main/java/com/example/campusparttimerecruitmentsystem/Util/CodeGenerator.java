...
public class CodeGenerator {
    public static void main(String[] args) {
        generator("徐渝钦", "campusparttimerecruitmentsystem", "com.example.campusparttimerecruitmentsystem", "", "job_posts");
    ...
    public static void generator(String author,
        ...
        mpg.setDataSource(dataSourceConfig(
                "jdbc:mysql://127.0.0.1:3306/campus_part_time_recruitment_system?serverTimezone=Asia/Shanghai&useUnicode=true&characterEncoding=utf-8"
